...
function Header() {
  return (
    <div className='bg-zinc-900 text-white w-full max-h-screen flex items-center justify-end'>
      <Link href={'/'}>
        <a className='px-5 h-12 text-white flex items-center group mr-[50rem]'>
      ...
      <Link href={'/'}>
        <a className='px-5 h-12 text-white flex items-center group'>
          ...
          <ArrowRight color="white" className='mt-2 ml-5 h-6 w-6 animate-pulse group-hover:animate-ping group-focus:animate-ping' />
        </a>
      </Link>
    </div>
  )
