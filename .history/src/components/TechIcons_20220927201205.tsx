...
function TechIcons({ iconURL, iconAlt, iconTitle }: TechIconsProps) {
  return (
    <div className='relative border w-[400px] cursor-pointer group'>
        ...
        <span className='font-bold text-2xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 invisible group-hover:visible group-hover:animat '>{iconTitle}</span>
    </div>
  )
}
