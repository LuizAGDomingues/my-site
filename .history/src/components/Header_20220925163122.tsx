...
import { House, User, Code, GraduationCap, Browsers } from "phosphor-react";
...
function Header() {
  return (
    <div className='bg-zinc-900 text-white w-full flex items-center'>
      ...
      <Link href={'/'}>
        <a className='px-5 h-12 text-white flex items-center group'>
          <GraduationCap color="white" weight="fill" className='mt-1 h-6 w-6' />
          <span className='mt-2'>
            Certificações
          </span>
        </a>
      ...
      <Link href={'/'}>
        <a className='px-5 h-12 text-white flex items-center group'>
          <Browsers color="white" weight="fill" className='mt-1 h-6 w-6' />
          <span className='mt-2'>
            Projetos
          </span>
        </a>
