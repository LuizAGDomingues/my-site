    ...
    <div className='bg-zinc-900 text-white w-full flex items-center'>
      <Link href={'/'}>
        <a className='px-5 h-12 text-white flex items-center group'>
          ...
          <span className='mt-2 hidden overflow-hidden group-hover:max-w-xs group-focus:max-w-xs   transition-all duration-500 ease-linear'>
            Home
          </span>
        </a>
      </Link>
      <Link href={'/'}>
        <a className='px-5 h-12 text-white flex items-center group'>
          ...
          <span className='mt-2 max-w-0 overflow-hidden group-hover:max-w-xs group-focus:max-w-xs'>
            Sobre mim
          </span>
        </a>
      </Link>
