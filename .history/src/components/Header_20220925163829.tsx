...
function Header() {
  return (
    <div className='bg-zinc-900 text-white w-full flex items-center'>
      ...
      <Link href={'/'}>
        <a className='px-5 h-12 text-white flex items-center group hover:border hover:border-purple-600 '>
          <AppWindow color="white" className='mt-1 h-6 w-6' />
          <span className='mt-2'>
            Página de aplicações
          </span>
          <ArrowRight color="white" className='mt-2 ml-2 h-6 w-6 animate-pulse' />
        </a>
      </Link>
    </div>
  )
