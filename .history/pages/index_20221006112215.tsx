  ...
  return (
    <>
      ...
      <div className='bg-galaxy w-full bg-cover bg-no-repeat text-white'>
        { renderHeaderMenu ? <HeaderMenu refs={['about', 'tech', 'certifications', 'projects']} /> : <Header refs={['about', 'tech', 'certifications', 'projects']} /> }
        ...
        <div id='tech'>
          { renderTech ?
            <div className='ml-[20rem] grid grid-cols-3 overflow-hidden'>
