      ...
      <div className='bg-galaxy w-full bg-cover bg-no-repeat text-white'>
        ...
        { renderTech ?
          <div ref={tech} id='tech' className='ml-72 grid grid-cols-3'>
            ...
            <div className='animate-move-right' style={{animationFillMode: 'backwards', animationDelay: '.2s'}}>
            ...
            <div className='animate-move-right' style={{animationFillMode: 'backwards', animationDelay: '.4s'}}>
