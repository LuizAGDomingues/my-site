  ...
  return (
    <>
      ...
      <div className='bg-galaxy w-full bg-cover bg-no-repeat text-white'>
        ...
        <div ref={tech} className='py-16 ml-52 grid grid-cols-3'>
          ...
          <TechIcons iconURL='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg' iconAlt='Javascript icon' iconTitle='ReactJs' />
        </div>
      </div>
    </>
  )
