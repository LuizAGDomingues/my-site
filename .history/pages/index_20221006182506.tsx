...
const Home: NextPage = () => {
  ...
  const [renderCertifications, setRenderCertifications] = useState('invisible');
  const [renderTech, setRenderTech] = useState('invisible');
  ...
  useEffect(() => {
    function scrollPosition(){
      ...
      if(window.scrollY > 700){
        setRenderTech('visible');
        setRenderCertifications('visible');
      }
    }
  ...
  return (
    <>
      ...
      <div className='bg-galaxy w-full bg-cover bg-no-repeat text-white'>
        ...
        <div id='tech'>
          <div className={`ml-[20rem] mt-48 grid grid-cols-3 overflow-hidden ${renderTech}`}>
        ...
        <div id='certifications' className={`mt-64 ${renderCertifications}`}>
          <Certifications />
        </div>
        <div id='projects' className='mt-64'>
          Projetos
        </div>
      </div>
    </>
