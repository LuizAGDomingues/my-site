  ...
  return (
    <>
      ...
      <div className='bg-galaxy w-full bg-cover bg-no-repeat text-white'>
        ...
        { renderTech ?
          <div id='tech' className='ml-[20rem] grid grid-cols-3 overflow-hidden'>
          ...
          : <span id='tech' className='h-[50.8rem] flex items-center justify-center text-2xl'>Loading</span>
        }
