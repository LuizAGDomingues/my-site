...
const Home: NextPage = () => {
  ...
  return (
    <div className='bg-galaxy w-full h-screen bg-cover bg-no-repeat'>
      <Header refs={about} />
      ...
      <div className='bg-black text-white w-full h-96 flex items-center justify-center'>OOOOPA</div>
    </div>
  )
}
