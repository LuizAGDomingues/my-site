  ...
  return (
    <>
      ...
      <div className='bg-galaxy w-full bg-cover bg-no-repeat text-white'>
        ...
        { renderTech ?
          <div ref={tech} id='tech' className='ml-72 grid grid-cols-3'>
            <div className='animate-move-right-1' style={{animationFillMode: 'backwards'}}>
            ...
            <div className='animate-move-right-2' style={{animationFillMode: 'backwards'}}>
            ...
            <div className='animate-move-right-3' style={{animationFillMode: 'backwards'}}>
