...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className='bg-galaxy h-full w-full bg-cover bg-no-repeat'>
        <Header refs={[about, tech]} />
        ...
        <div ref={tech}>
          <div>
            <Image src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" key={1} alt='React logo' width={100} height={100} layout='responsive' />
          </div>
        </div>
      </div>
    </>
