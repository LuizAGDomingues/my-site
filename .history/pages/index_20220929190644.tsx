  ...
  return (
    <>
      ...
      <div className='bg-galaxy w-full bg-cover bg-no-repeat text-white'>
        ...
        { renderTech ?
          <div ref={tech} id='tech' className='ml-72 grid grid-cols-3 overflow-hidden'>
            ...
            <div className='animate-move-' style={{animationFillMode: 'backwards'}}>
            ...
            <div className='animate-fade' style={{animationFillMode: 'backwards', animationDelay: '.5s'}}>
