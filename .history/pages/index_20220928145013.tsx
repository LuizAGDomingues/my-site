  ...
  return (
    <>
      ...
      <div className='bg-galaxy w-full bg-cover bg-no-repeat text-white'>
        ...
        <div ref={tech} className='mt-16 ml-36 grid grid-cols-3'>
          <TechIcons iconURL='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg' iconAlt='HTML5 icon' iconTitle='ReactJs' />
